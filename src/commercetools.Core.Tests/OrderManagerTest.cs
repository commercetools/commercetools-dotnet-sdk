...
using commercetools.Core.Orders;
using commercetools.Core.Orders.UpdateActions;
...
namespace commercetools.Core.Tests
{
    ...
    public class OrderManagerTest : IDisposable
    {
        ...
        /// <seealso cref="OrderManager.DeleteOrderAsync(Order)"/>
        [Fact]
        ...
        /// </summary>
        /// <see cref="OrderManager.UpdateOrderAsync(Order, System.Collections.Generic.List{UpdateAction})"/>
        [Fact]

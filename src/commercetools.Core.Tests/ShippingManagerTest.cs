...
namespace commercetools.Core.Tests
{
    ...
    /// </summary>
    public class ShippingMethodManagerTest : IDisposable
    {
        ...
        public async Task ShouldGetShippingMethodByIdAsync()
        {
            ...
            Assert.NotNull(shippingMethod.Id);
            Assert.Equal(shippingMethod.Id, _testShippingMethods[0].Id);
        }
        ...
        public async Task ShouldQueryShippingMethodsAsync()
        {
            ...
            Assert.True(shippingMethodQueryResult.Results.Count >= 1);
            ...
            Assert.NotNull(shippingMethodQueryResult.Results);
            Assert.True(shippingMethodQueryResult.Results.Count <= limit);
        }
        ...
        /// <seealso cref="ShippingMethodManager.DeleteShippingMethodAsync(ShippingMethod)"/>
        [Fact]
        ...
        /// </summary>
        /// <see cref="ShippingMethodManager.UpdateShippingMethodAsync(ShippingMethod, System.Collections.Generic.List{UpdateAction})"/>
        [Fact]
        public async Task ShouldUpdateShippingMethodAsync()
        {
            ...
            {
                Assert.Equal(_testShippingMethods[0].Name, newName);
                Assert.Equal(_testShippingMethods[0].Description, newDescription);
            }
        }
    }
}
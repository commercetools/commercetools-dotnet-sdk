...
{
    public class DiscountCodeExpanded
    {
        #region properties
        ...
        public List<CartDiscountExpandedReference> CartDiscounts { get; private set; }
        ...
        public DiscountCodeExpanded(dynamic data)
        {
            if (data == null)
            {
                return;
            ...
            this.Code = data.code;
            this.CartDiscounts = Helper.GetListFromJsonArray<CartDiscountExpandedReference>(data.cartDiscounts);
